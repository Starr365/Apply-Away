...
export function LandingCTA() {
  return (
    <section className="w-full py-24 px-4 sm:px-6 relative overflow-hidden">
      ...
      <AnimatedContainer
        delay={150}
        className="max-w-5xl w-full mx-auto bg-primary border border-primary p-8 sm:p-14 rounded-3xl text-center space-y-6 relative z-10 shadow-2xl text-primary-foreground"
      >
        ...
        <h2 className="text-3xl sm:text-5xl font-extrabold tracking-tight font-outfit text-primary-foreground max-w-3xl mx-auto leading-tight">
          Your next opportunity is probably already somewhere in your phone. <br />
          <span className="text-primary-foreground font-black underline decoration-primary-foreground/30">
