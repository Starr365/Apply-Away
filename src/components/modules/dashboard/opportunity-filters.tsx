    ...
    <div className="glass-panel p-4 rounded-2xl space-y-4 sm:space-y-0 sm:flex sm:items-center sm:justify-between sm:gap-4">
      ...
      <form onSubmit={handleSearchSubmit} className="flex-1 min-w-50 relative">
        ...
        <input
          ...
          className="w-full h-11 pl-10 pr-4 rounded-xl bg-card border border-input text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-ring/50"
        />
      </form>
      ...
      <div className="flex flex-wrap items-center gap-2">
        ...
        {hasActiveFilters && (
          <button
            ...
            className="h-11 px-3 rounded-xl bg-secondary hover:bg-secondary/80 text-xs text-foreground flex items-center space-x-1.5 transition-colors cursor-pointer"
          >
