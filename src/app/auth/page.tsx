      ...
      <div className="w-full max-w-md space-y-8">
        ...
        <div className="flex justify-center space-x-4 mb-4" role="tablist" aria-label="Authentication Options">
          <button
            ...
            className={`px-4 py-2 rounded-t-xl font-semibold text-sm transition-colors cursor-pointer ${mode === "signin" ? "bg-secondary text-foreground border-b-2 border-primary" : "bg-muted/50 text-muted-foreground hover:text-foreground"}`}
          >
            Sign In
          </button>
          <button
            ...
            className={`px-4 py-2 rounded-t-xl font-semibold text-sm transition-colors cursor-pointer ${mode === "signup" ? "bg-secondary text-foreground border-b-2 border-primary" : "bg-muted/50 text-muted-foreground hover:text-foreground"}`}
          >
            Sign Up
          </button>
        </div>
        ...
        <div className="glass-panel p-6 sm:p-8 rounded-3xl space-y-6 shadow-2xl">
          ...
          <button
            ...
            disabled={isLoading}
            className="w-full h-12 flex items-center justify-center space-x-3 rounded-xl bg-card border border-border hover:bg-secondary text-sm font-semibold text-foreground transition-all cursor-pointer disabled:opacity-50"
          >
          ...
          <div className="relative flex items-center justify-center my-4">
            ...
            <span className="bg-background px-3 text-xs text-muted-foreground uppercase font-medium absolute">Or {mode === "signin" ? "sign in" : "sign up"} with email</span>
          </div>
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full h-11 pl-4 pr-12 rounded-xl bg-card border border-input text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-ring/50"
                />
                <button
                  type="button"
